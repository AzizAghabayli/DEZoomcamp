...
public class JsonConsumer {
    ...
    public JsonConsumer() {
        props.put(ConsumerConfig.BOOTSTRAP_SERVERS_CONFIG, "pkc-n3603.us-central1.gcp.confluent.cloud:9092");
        props.put("security.protocol", "SASL_SSL");
        props.put("sasl.jaas.config",
                "org.apache.kafka.common.security.plain.PlainLoginModule required username='JDMNZANKQSV3HGNZ' password='j4vdq1D2+/xTamj0pdBdFz3B5SNgiLYOt151L84ehYmk/3+PcS78G2h6rvK8QF5f';");
